...
class bank_statement_ocr(_open_cv_stuff.Mixin,_bb.Mixin1,_bradesco.Mixin2,
    ...
    def process_document(self,bank):
        ...
        if self.bank == 'inter':
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[1170:-380,:,:]
                else:
                    page = np.array(self.pages[i])[340:-380,:,:]
                # zeroing margins
                page[:,200:300,:] = 255
                page[:,2140:2500,:] = 255
                page[:,470:485,:] = 255
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[700:-110,:,:]
                else:
                    page = np.array(self.pages[i])[110:-110,:,:]
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[1100:-110,:,:]
                else:
                    page = np.array(self.pages[i])[110:-110,:,:]
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[1020:-110,:,:]
                else:
                    page = np.array(self.pages[i])[110:-110,:,:]
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[780:-110,:,:]
                else:
                    page = np.array(self.pages[i])[110:-110,:,:]
                # zeroing margins
                page[:,200:300,:] = 255
            ...
            if pytesseract.image_to_string(np.array(self.pages[0])[150:230,600:1300,:],config=r'--oem 3 --psm 7') == 'Extrato Mensal / Por Periodo':
                ...
                for i in np.arange(0,len(self.pages)):
                    if i == 0:
                        page = np.array(self.pages[i])[900:-110,:,:]
                    else:
                        page = np.array(self.pages[i])[110:-110,:,:]
                ...
                for i in np.arange(0,len(self.pages)):
                    if i == 0:
                        page = np.array(self.pages[i])[836:-110,:,:]
                    else:
                        page = np.array(self.pages[i])[110:-110,:,:]
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[1050:-100,:,:]
                else:
                    page = np.array(self.pages[i])[100:-100,:,:]
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[2500:-100,500:2400,:]
                else:
                    page = np.array(self.pages[i])[440:-100,500:2400,:]
                # zeroing margins
                page[:,0:100,:] = 255
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[1000:-100,50:2400,:]
                else:
                    page = np.array(self.pages[i])[100:-100,50:2400,:]
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[1250:-100,450:2400,:]
                else:
                    page = np.array(self.pages[i])[100:-100,450:2400,:]
                # zeroing margins
                page[:,:30,:] = 255
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[400:-110,:,:]
                else:
                    page = np.array(self.pages[i])[110:-110,:,:]
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[1550:-110,:,:]
                else:
                    page = np.array(self.pages[i])[110:-110,:,:]
                # zeroing margins
                page[:,2000:2600,:] = 255
            ...
            for i in np.arange(0,len(self.pages)):
                if i == 0:
                    page = np.array(self.pages[i])[1070:-370,50:2500,:]
                else:
                    page = np.array(self.pages[i])[600:-370,50:2500,:]
    ...
    def start_analysis(self):
        ...
        if pdfbank is None:
            ...
            if len(self.pages) == 0 or self.pages is None:
